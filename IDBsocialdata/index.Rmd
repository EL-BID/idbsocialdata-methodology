---
title: "Data and Indicators for Latin America and the Caribbean (LAC): Methodology Handbook"
...
```{r IDB, out.width='40%', fig.align='left', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link='https://www.iadb.org/en/sharing-knowledge/data/social-data', fig.show='hold',  out.extra='style="float:right; padding:0px"'}
